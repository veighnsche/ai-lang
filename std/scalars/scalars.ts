...
export function std__int__pow(base: bigint, exponent: bigint): ScalarsResult {
  if ((exponent >= 0n)) {
    const $ail_m1: ScalarsResult = std__int__pow_from(base, exponent);
    switch ($ail_m1.$ail_kind) {
    case "ok": {
      const r = $ail_m1;
...
export function std__int__factorial_from(value: bigint): ScalarsResult {
  if ((value <= 0n)) {
    ...
    const $ail_m1: ScalarsResult = std__int__factorial_from((value - 1n));
    switch ($ail_m1.$ail_kind) {
    case "ok": {
      const r = $ail_m1;
...
export function std__int__factorial(value: bigint): ScalarsResult {
  if ((value >= 0n)) {
    const $ail_m1: ScalarsResult = std__int__factorial_from(value);
    switch ($ail_m1.$ail_kind) {
    case "ok": {
      const r = $ail_m1;
      return { $ail_kind: "ok", value: r.value };
...
export function std__int__sum_from(upper: bigint): ScalarsResult {
  if ((upper <= 0n)) {
    ...
    const $ail_m1: ScalarsResult = std__int__sum_from((upper - 1n));
    switch ($ail_m1.$ail_kind) {
    case "ok": {
      const r = $ail_m1;
...
export function std__int__sum_to(upper: bigint): ScalarsResult {
  if ((upper >= 0n)) {
    const $ail_m1: ScalarsResult = std__int__sum_from(upper);
    switch ($ail_m1.$ail_kind) {
    case "ok": {
      const r = $ail_m1;
      return { $ail_kind: "ok", value: r.value };
...
export function std__int__binomial_from(n: bigint, k: bigint, i: bigint, num: bigint, den: bigint): ScalarsResult {
  if ((i <= 0n)) {
    ...
    const $ail_m1: ScalarsResult = std__int__binomial_from(n, k, (i - 1n), (num * ((n - k) + i)), (den * i));
    switch ($ail_m1.$ail_kind) {
    case "ok": {
      const r = $ail_m1;
      return { $ail_kind: "ok", value: r.value };
...
export function std__int__binomial(n: bigint, k: bigint): ScalarsResult {
  ...
  const $ail_m2 = (k <= n);
  if ($ail_m1 && $ail_m2) {
    const $ail_m3: ScalarsResult = std__int__binomial_from(n, k, k, 1n, 1n);
...
export function std__int__is_prime_from(value: bigint, e: bigint): ScalarsResult {
  if ((e <= 0n)) {
    ...
    if (($ailDivMod(value, (e + 1n))[1] === 0n)) {
      ...
      const $ail_m1: ScalarsResult = std__int__is_prime_from(value, (e - 1n));
      switch ($ail_m1.$ail_kind) {
      case "ok": {
        const r = $ail_m1;
        return { $ail_kind: "ok", value: r.value };
...
export function std__int__is_prime(value: bigint): ScalarsResult {
  if ((value >= 2n)) {
    const $ail_m1: ScalarsResult = std__int__is_prime_from(value, (value - 2n));
    switch ($ail_m1.$ail_kind) {
    case "ok": {
      const r = $ail_m1;
      return { $ail_kind: "ok", value: r.value };
...
export function std__int__next_power_of_two_pow2(e: bigint): ScalarsResult {
  if ((e <= 0n)) {
    ...
    const $ail_m1: ScalarsResult = std__int__next_power_of_two_pow2((e - 1n));
    switch ($ail_m1.$ail_kind) {
    case "ok": {
      const r = $ail_m1;
...
export function std__int__next_power_of_two_from(value: bigint, e: bigint, best: bigint): ScalarsResult {
  if ((e <= 0n)) {
    ...
    const $ail_m1: ScalarsResult = std__int__next_power_of_two_pow2(e);
    switch ($ail_m1.$ail_kind) {
    case "ok": {
      const t = $ail_m1;
      if ((t.value >= value)) {
        const $ail_m2: ScalarsResult = std__int__next_power_of_two_from(value, (e - 1n), t.value);
        ...
        const $ail_m3: ScalarsResult = std__int__next_power_of_two_from(value, (e - 1n), best);
        switch ($ail_m3.$ail_kind) {
        case "ok": {
          const r = $ail_m3;
          return { $ail_kind: "ok", value: r.value };
...
export function std__int__next_power_of_two(value: bigint): ScalarsResult {
  if ((value >= 1n)) {
    const $ail_m1: ScalarsResult = std__int__next_power_of_two_from(value, value, 1n);
    switch ($ail_m1.$ail_kind) {
    case "ok": {
      const r = $ail_m1;
      return { $ail_kind: "ok", value: r.value };
...
export function std__int__sqrt_floor_search(value: bigint, lo: bigint, hi: bigint): ScalarsResult {
  if (((hi - lo) <= 1n)) {
    ...
    if ((($ailDivMod((lo + hi), 2n)[0] * $ailDivMod((lo + hi), 2n)[0]) <= value)) {
      const $ail_m1: ScalarsResult = std__int__sqrt_floor_search(value, $ailDivMod((lo + hi), 2n)[0], hi);
      switch ($ail_m1.$ail_kind) {
      case "ok": {
        const r = $ail_m1;
        return { $ail_kind: "ok", value: r.value };
      ...
      const $ail_m2: ScalarsResult = std__int__sqrt_floor_search(value, lo, $ailDivMod((lo + hi), 2n)[0]);
      switch ($ail_m2.$ail_kind) {
      case "ok": {
        const r = $ail_m2;
        return { $ail_kind: "ok", value: r.value };
...
export function std__int__sqrt_floor(value: bigint): ScalarsResult {
  if ((value >= 0n)) {
    const $ail_m1: ScalarsResult = std__int__sqrt_floor_search(value, 0n, (value + 1n));
    switch ($ail_m1.$ail_kind) {
    case "ok": {
      const r = $ail_m1;
...
export function std__int__gcd_euclid(a: bigint, b: bigint): ScalarsResult {
  if ((b <= 0n)) {
    ...
    const $ail_m1: ScalarsResult = std__int__gcd_euclid(b, $ailDivMod(a, b)[1]);
    switch ($ail_m1.$ail_kind) {
    case "ok": {
      const r = $ail_m1;
      return { $ail_kind: "ok", value: r.value };
...
export function std__int__gcd(left: bigint, right: bigint): ScalarsResult {
  const $ail_m1: ScalarsResult = std__int__abs(left);
  switch ($ail_m1.$ail_kind) {
  case "ok": {
    const a = $ail_m1;
    const $ail_m2: ScalarsResult = std__int__abs(right);
    switch ($ail_m2.$ail_kind) {
    case "ok": {
      const b = $ail_m2;
      const $ail_m3: ScalarsResult = std__int__gcd_euclid(a.value, b.value);
      switch ($ail_m3.$ail_kind) {
      case "ok": {
        const r = $ail_m3;
        return { $ail_kind: "ok", value: r.value };
...
export function std__int__lcm(left: bigint, right: bigint): ScalarsResult {
  ...
  if ($ail_m1) {
    ...
    const $ail_m3: ScalarsResult = std__int__gcd(left, right);
    switch ($ail_m3.$ail_kind) {
    case "ok": {
      const g = $ail_m3;
      const $ail_m4: ScalarsResult = std__int__abs(left);
      switch ($ail_m4.$ail_kind) {
      case "ok": {
        const a = $ail_m4;
        const $ail_m5: ScalarsResult = std__int__abs(right);
...
export function std__dec__pow_from(base: string, exponent: bigint): ScalarsResult {
  if ((exponent <= 0n)) {
    ...
    const $ail_m1: ScalarsResult = std__dec__pow_from(base, (exponent - 1n));
    switch ($ail_m1.$ail_kind) {
    case "ok": {
      const r = $ail_m1;
...
export function std__dec__pow(base: string, exponent: bigint): ScalarsResult {
  if ((exponent >= 0n)) {
    const $ail_m1: ScalarsResult = std__dec__pow_from(base, exponent);
    switch ($ail_m1.$ail_kind) {
    case "ok": {
      const r = $ail_m1;
      return { $ail_kind: "ok", value: r.value };
...
export function std__dec__scale_by_power_of_ten_from(value: string, e: bigint, factor: string): ScalarsResult {
  if ((e <= 0n)) {
    ...
    const $ail_m1: ScalarsResult = std__dec__scale_by_power_of_ten_from($ailDecMul(value, factor), (e - 1n), factor);
    switch ($ail_m1.$ail_kind) {
    case "ok": {
      const r = $ail_m1;
      return { $ail_kind: "ok", value: r.value };
...
export function std__dec__scale_by_power_of_ten(value: string, exponent: bigint): ScalarsResult {
  if ((exponent >= 0n)) {
    const $ail_m1: ScalarsResult = std__dec__scale_by_power_of_ten_from(value, exponent, "10.0");
    switch ($ail_m1.$ail_kind) {
    case "ok": {
      const r = $ail_m1;
      return { $ail_kind: "ok", value: r.value };
    ...
    const $ail_m2: ScalarsResult = std__dec__scale_by_power_of_ten_from(value, (0n - exponent), "0.1");
    switch ($ail_m2.$ail_kind) {
    case "ok": {
      const r = $ail_m2;
      return { $ail_kind: "ok", value: r.value };
...
export function std__dec__from_parts(coefficient: bigint, scale: bigint): ScalarsResult {
  if ((scale >= 0n)) {
    const $ail_m1: ScalarsResult = std__convert__int_to_dec(coefficient);
    switch ($ail_m1.$ail_kind) {
    case "ok": {
      const whole = $ail_m1;
      const $ail_m2: ScalarsResult = std__dec__scale_by_power_of_ten(whole.value, (0n - scale));
      switch ($ail_m2.$ail_kind) {
      case "ok": {
        const moved = $ail_m2;
...
export function std__dec__strip_from(remaining: bigint, current: bigint, exact: boolean): ScalarsResult {
  if ((remaining <= 0n)) {
    ...
    if (($ailDivMod(current, 10n)[1] === 0n)) {
      const $ail_m1: ScalarsResult = std__dec__strip_from((remaining - 1n), $ailDivMod(current, 10n)[0], exact);
      switch ($ail_m1.$ail_kind) {
      case "ok": {
        const r = $ail_m1;
      ...
      const $ail_m2: ScalarsResult = std__dec__strip_from((remaining - 1n), $ailDivMod(current, 10n)[0], false);
      switch ($ail_m2.$ail_kind) {
      case "ok": {
        const r = $ail_m2;
        return { $ail_kind: "ok", stripped: r.stripped, exact: r.exact };
...
export function std__dec__truncate(value: string): ScalarsResult {
  const $ail_m1: ScalarsResult = std__dec__parts(value);
  switch ($ail_m1.$ail_kind) {
  case "ok": {
    const p = $ail_m1;
    const $ail_m2: ScalarsResult = std__dec__strip_from(p.scale, p.coefficient, true);
    switch ($ail_m2.$ail_kind) {
    case "ok": {
      const s = $ail_m2;
      if (s.exact) {
        const $ail_m3: ScalarsResult = std__convert__int_to_dec(s.stripped);
        switch ($ail_m3.$ail_kind) {
        case "ok": {
          const whole = $ail_m3;
        ...
        if ((s.stripped >= 0n)) {
          const $ail_m4: ScalarsResult = std__convert__int_to_dec(s.stripped);
          switch ($ail_m4.$ail_kind) {
          case "ok": {
            const whole = $ail_m4;
            return { $ail_kind: "ok", value: whole.value };
          ...
          const $ail_m5: ScalarsResult = std__convert__int_to_dec((s.stripped + 1n));
          switch ($ail_m5.$ail_kind) {
          case "ok": {
            const whole = $ail_m5;
            return { $ail_kind: "ok", value: whole.value };
  ...
  case "ok": {
    ...
    case "ok": {
      ...
      if (s.exact) {
        ...
        const $ail_m4: ScalarsResult = std__convert__int_to_dec((s.stripped + 1n));
        switch ($ail_m4.$ail_kind) {
        case "ok": {
          const whole = $ail_m4;
          return { $ail_kind: "ok", value: whole.value };
  ...
  if ((fuel <= 0n)) {
    ...
    if ((current === 1n)) {
      ...
      if (($ailDivMod(current, 2n)[1] === 0n)) {
        const $ail_m1: ScalarsResult = std__dec__strip257_from((fuel - 1n), $ailDivMod(current, 2n)[0], (twos + 1n), fives);
        switch ($ail_m1.$ail_kind) {
        case "ok": {
          const r = $ail_m1;
        ...
        if (($ailDivMod(current, 5n)[1] === 0n)) {
          const $ail_m2: ScalarsResult = std__dec__strip257_from((fuel - 1n), $ailDivMod(current, 5n)[0], twos, (fives + 1n));
          switch ($ail_m2.$ail_kind) {
          case "ok": {
            const r = $ail_m2;
            return { $ail_kind: "ok", rest: r.rest, twos: r.twos, fives: r.fives };
...
export function std__dec__divide_exact(dividend: string, divisor: string): ScalarsResult {
  const $ail_m1: ScalarsResult = std__dec__parts(divisor);
  switch ($ail_m1.$ail_kind) {
  case "ok": {
    const d = $ail_m1;
    if ((d.coefficient === 0n)) {
      ...
      const $ail_m2: ScalarsResult = std__dec__parts(dividend);
      switch ($ail_m2.$ail_kind) {
      case "ok": {
        const n = $ail_m2;
        const $ail_m3: ScalarsResult = std__int__pow_from(10n, d.scale);
        switch ($ail_m3.$ail_kind) {
        case "ok": {
          const pds = $ail_m3;
          const $ail_m4: ScalarsResult = std__int__pow_from(10n, n.scale);
          switch ($ail_m4.$ail_kind) {
          case "ok": {
            const pns = $ail_m4;
            const $ail_m5: ScalarsResult = std__int__abs((n.coefficient * pns.value));
            switch ($ail_m5.$ail_kind) {
            case "ok": {
              const an = $ail_m5;
              const $ail_m6: ScalarsResult = std__int__abs((d.coefficient * pds.value));
              switch ($ail_m6.$ail_kind) {
              case "ok": {
                const ad = $ail_m6;
                const $ail_m7: ScalarsResult = std__int__gcd(an.value, ad.value);
                switch ($ail_m7.$ail_kind) {
                case "ok": {
                  const g = $ail_m7;
                  const $ail_m8: ScalarsResult = std__dec__strip257_from($ailDivMod(ad.value, g.value)[0], $ailDivMod(ad.value, g.value)[0], 0n, 0n);
                  switch ($ail_m8.$ail_kind) {
                  case "ok": {
                    const f = $ail_m8;
                    if ((f.rest === 1n)) {
                      const $ail_m9: ScalarsResult = std__int__max(f.twos, f.fives);
                      switch ($ail_m9.$ail_kind) {
                      case "ok": {
                        const m = $ail_m9;
                        const $ail_m10: ScalarsResult = std__int__pow_from(10n, m.value);
                        switch ($ail_m10.$ail_kind) {
                        case "ok": {
                          const p10 = $ail_m10;
                          const $ail_m11: ScalarsResult = std__convert__int_to_dec(($ailDivMod(an.value, g.value)[0] * $ailDivMod(p10.value, $ailDivMod(ad.value, g.value)[0])[0]));
                          switch ($ail_m11.$ail_kind) {
                          case "ok": {
                            const qi = $ail_m11;
                            const $ail_m12: ScalarsResult = std__dec__scale_by_power_of_ten(qi.value, (0n - m.value));
  ...
  if ((scale >= 0n)) {
    ...
    case "ok": {
      ...
      if ((p.scale <= scale)) {
        ...
        const $ail_m2: ScalarsResult = std__int__pow_from(10n, (p.scale - scale));
        switch ($ail_m2.$ail_kind) {
        case "ok": {
          const pd = $ail_m2;
          const $ail_m3: ScalarsResult = std__int__abs(p.coefficient);
          switch ($ail_m3.$ail_kind) {
          case "ok": {
            const a = $ail_m3;
            ...
            if ($ail_m4 && $ail_m5) {
              const $ail_m7: ScalarsResult = std__convert__int_to_dec($ailDivMod(a.value, pd.value)[0]);
              switch ($ail_m7.$ail_kind) {
              case "ok": {
                const qi = $ail_m7;
                const $ail_m8: ScalarsResult = std__dec__scale_by_power_of_ten(qi.value, (0n - scale));
                switch ($ail_m8.$ail_kind) {
                case "ok": {
                  const q = $ail_m8;
              ...
              const $ail_m9: ScalarsResult = std__convert__int_to_dec(($ailDivMod(a.value, pd.value)[0] + 1n));
              switch ($ail_m9.$ail_kind) {
              case "ok": {
                const qi = $ail_m9;
                const $ail_m10: ScalarsResult = std__dec__scale_by_power_of_ten(qi.value, (0n - scale));
                switch ($ail_m10.$ail_kind) {
                case "ok": {
                  const q = $ail_m10;
                  if ($ailDecLt(value, "0.0")) {
              ...
              const $ail_m11: ScalarsResult = std__convert__int_to_dec(($ailDivMod(a.value, pd.value)[0] + 1n));
              switch ($ail_m11.$ail_kind) {
              case "ok": {
                const qi = $ail_m11;
                const $ail_m12: ScalarsResult = std__dec__scale_by_power_of_ten(qi.value, (0n - scale));
                switch ($ail_m12.$ail_kind) {
                case "ok": {
                  const q = $ail_m12;
                  if ($ailDecLt(value, "0.0")) {
              ...
              const $ail_m13: ScalarsResult = std__convert__int_to_dec($ailDivMod(a.value, pd.value)[0]);
              switch ($ail_m13.$ail_kind) {
              case "ok": {
                const qi = $ail_m13;
                const $ail_m14: ScalarsResult = std__dec__scale_by_power_of_ten(qi.value, (0n - scale));
...
export function std__dec__divide_round_half_even_result(qm: bigint, scale: bigint, num: bigint, den: bigint, dividend: string, divisor: string): ScalarsResult {
  const $ail_m1: ScalarsResult = std__convert__int_to_dec(qm);
  switch ($ail_m1.$ail_kind) {
  case "ok": {
    const qi = $ail_m1;
    const $ail_m2: ScalarsResult = std__dec__scale_by_power_of_ten(qi.value, (0n - scale));
    switch ($ail_m2.$ail_kind) {
    case "ok": {
      const q = $ail_m2;
      const $ail_m3 = (num < 0n);
          ...
          case "ok": {
            ...
            case "ok": {
              ...
              case "ok": {
                ...
                case "ok": {
                  const ad = $ail_m6;
                  const $ail_m7: ScalarsResult = std__int__pow_from(10n, scale);
                  switch ($ail_m7.$ail_kind) {
                  case "ok": {
                    const psc = $ail_m7;
                    ...
                    if ($ail_m8 && $ail_m9) {
                      const $ail_m11: ScalarsResult = std__dec__divide_round_half_even_result($ailDivMod((an.value * psc.value), ad.value)[0], scale, (n.coefficient * pns.value), (d.coefficient * pds.value), dividend, divisor);
                      switch ($ail_m11.$ail_kind) {
                      case "ok": {
                        const r = $ail_m11;
                      ...
                      const $ail_m12: ScalarsResult = std__dec__divide_round_half_even_result(($ailDivMod((an.value * psc.value), ad.value)[0] + 1n), scale, (n.coefficient * pns.value), (d.coefficient * pds.value), dividend, divisor);
                      switch ($ail_m12.$ail_kind) {
                      case "ok": {
                        const r = $ail_m12;
                        return { $ail_kind: "ok", value: r.value, remainder: r.remainder };
                      ...
                      const $ail_m13: ScalarsResult = std__dec__divide_round_half_even_result(($ailDivMod((an.value * psc.value), ad.value)[0] + 1n), scale, (n.coefficient * pns.value), (d.coefficient * pds.value), dividend, divisor);
                      switch ($ail_m13.$ail_kind) {
                      case "ok": {
                        const r = $ail_m13;
                        return { $ail_kind: "ok", value: r.value, remainder: r.remainder };
                      ...
                      const $ail_m14: ScalarsResult = std__dec__divide_round_half_even_result($ailDivMod((an.value * psc.value), ad.value)[0], scale, (n.coefficient * pns.value), (d.coefficient * pds.value), dividend, divisor);
                      switch ($ail_m14.$ail_kind) {
                      case "ok": {
                        const r = $ail_m14;
                        return { $ail_kind: "ok", value: r.value, remainder: r.remainder };
...
export function std__convert__dec_to_str(value: string): ScalarsResult {
  ...
  case "ok": {
    const p = $ail_m1;
    const $ail_m2: ScalarsResult = std__int__abs(p.coefficient);
    switch ($ail_m2.$ail_kind) {
    case "ok": {
      const a = $ail_m2;
      const $ail_m3: ScalarsResult = std__int__pow_from(10n, p.scale);
      switch ($ail_m3.$ail_kind) {
      case "ok": {
        const p10 = $ail_m3;
        const $ail_m4: ScalarsResult = std__convert__int_to_str($ailDivMod(a.value, p10.value)[0]);
        switch ($ail_m4.$ail_kind) {
        case "ok": {
          const ip = $ail_m4;
          const $ail_m5: ScalarsResult = std__convert__int_to_str(($ailDivMod(a.value, p10.value)[1] + p10.value));
          switch ($ail_m5.$ail_kind) {
          case "ok": {
            const fp = $ail_m5;
            if ((p.coefficient < 0n)) {
  ...
  case "ok": {
    ...
    if ((p.coefficient < 0n)) {
      ...
      if (($ailDivMod(p.scale, 2n)[1] === 0n)) {
        const $ail_m2: ScalarsResult = std__int__sqrt_floor_search(p.coefficient, 0n, (p.coefficient + 1n));
        switch ($ail_m2.$ail_kind) {
        case "ok": {
          const r = $ail_m2;
          if (((p.coefficient - (r.value * r.value)) === 0n)) {
            const $ail_m3: ScalarsResult = std__convert__int_to_dec(r.value);
            switch ($ail_m3.$ail_kind) {
            case "ok": {
              const qi = $ail_m3;
              const $ail_m4: ScalarsResult = std__dec__scale_by_power_of_ten(qi.value, (0n - $ailDivMod(p.scale, 2n)[0]));
              switch ($ail_m4.$ail_kind) {
              case "ok": {
                const q = $ail_m4;
                return { $ail_kind: "ok", value: q.value };
        ...
        const $ail_m5: ScalarsResult = std__int__sqrt_floor_search((p.coefficient * 10n), 0n, ((p.coefficient * 10n) + 1n));
        switch ($ail_m5.$ail_kind) {
        case "ok": {
          const r = $ail_m5;
          if ((((p.coefficient * 10n) - (r.value * r.value)) === 0n)) {
            const $ail_m6: ScalarsResult = std__convert__int_to_dec(r.value);
            switch ($ail_m6.$ail_kind) {
            case "ok": {
              const qi = $ail_m6;
              const $ail_m7: ScalarsResult = std__dec__scale_by_power_of_ten(qi.value, (0n - $ailDivMod((p.scale + 1n), 2n)[0]));
              switch ($ail_m7.$ail_kind) {
              case "ok": {
                const q = $ail_m7;
                return { $ail_kind: "ok", value: q.value };
...
export function std__convert__int_to_dec_from(m: bigint, acc: string, step: string): ScalarsResult {
  if ((m <= 0n)) {
    ...
    const $ail_m1: ScalarsResult = std__convert__int_to_dec_from((m - 1n), $ailDecAdd(acc, step), step);
    switch ($ail_m1.$ail_kind) {
    case "ok": {
      const r = $ail_m1;
      return { $ail_kind: "ok", value: r.value };
...
export function std__convert__int_to_str_from(n: bigint, acc: string, m: bigint): ScalarsResult {
  if ((m <= 0n)) {
    ...
    if ((n <= 9n)) {
      ...
      const $ail_m1: ScalarsResult = std__convert__int_to_str_from($ailDivMod(n, 10n)[0], ($ailStrSlice("0123456789", $ailDivMod(n, 10n)[1], ($ailDivMod(n, 10n)[1] + 1n)) + acc), (m - 1n));
      switch ($ail_m1.$ail_kind) {
      case "ok": {
        const r = $ail_m1;
        return { $ail_kind: "ok", value: r.value };
...
export function std__convert__int_to_str(value: bigint): ScalarsResult {
  if ((value < 0n)) {
    const $ail_m1: ScalarsResult = std__convert__int_to_str_from((0n - value), "", ((0n - value) + 1n));
    switch ($ail_m1.$ail_kind) {
    case "ok": {
      const r = $ail_m1;
      return { $ail_kind: "ok", value: ("-" + r.value) };
    ...
    const $ail_m2: ScalarsResult = std__convert__int_to_str_from(value, "", (value + 1n));
    switch ($ail_m2.$ail_kind) {
    case "ok": {
      const r = $ail_m2;
      return { $ail_kind: "ok", value: r.value };
  ...
  if ((n <= 0n)) {
    ...
    if (($ailStrAt(value, pos) >= 48n)) {
      if (($ailStrAt(value, pos) <= 57n)) {
        const $ail_m1: ScalarsResult = std__convert__str_to_int_from(orig, value, (pos + 1n), ((acc * 10n) + ($ailStrAt(value, pos) - 48n)), (n - 1n));
        switch ($ail_m1.$ail_kind) {
  ...
  if (((BigInt([...value].length)) === 0n)) {
    ...
    if (($ailStrSlice(value, 0n, 1n) === "-")) {
      if (((BigInt([...value].length)) >= 2n)) {
        const $ail_m1: ScalarsResult = std__convert__str_to_int_from(value, value, 1n, 0n, ((BigInt([...value].length)) - 1n));
        switch ($ail_m1.$ail_kind) {
        case "convert.invalid_integer": {
          const e = $ail_m1;
          return { $ail_kind: "convert.invalid_integer", value: e.value };
      ...
      const $ail_m2: ScalarsResult = std__convert__str_to_int_from(value, value, 0n, 0n, (BigInt([...value].length)));
      switch ($ail_m2.$ail_kind) {
      case "convert.invalid_integer": {
        const e = $ail_m2;
        return { $ail_kind: "convert.invalid_integer", value: e.value };
...
export function std__convert__str_to_dec_from(orig: string, value: string, pos: bigint, coeff: bigint, scale: bigint, dot: bigint, n: bigint): ScalarsResult {
  if ((n <= 0n)) {
    if ((dot === 0n)) {
      const $ail_m1: ScalarsResult = std__convert__int_to_dec(coeff);
      switch ($ail_m1.$ail_kind) {
      case "ok": {
        const whole = $ail_m1;
        return { $ail_kind: "ok", value: whole.value };
      ...
      if ((scale === 0n)) {
        ...
        const $ail_m2: ScalarsResult = std__convert__int_to_dec(coeff);
        switch ($ail_m2.$ail_kind) {
        case "ok": {
          const whole = $ail_m2;
          const $ail_m3: ScalarsResult = std__dec__scale_by_power_of_ten(whole.value, (0n - scale));
          switch ($ail_m3.$ail_kind) {
          case "ok": {
            const moved = $ail_m3;
            return { $ail_kind: "ok", value: moved.value };
    ...
    if (($ailStrSlice(value, pos, (pos + 1n)) === ".")) {
      if ((dot === 0n)) {
        const $ail_m4: ScalarsResult = std__convert__str_to_dec_from(orig, value, (pos + 1n), coeff, scale, 1n, (n - 1n));
        switch ($ail_m4.$ail_kind) {
      ...
      if (($ailStrAt(value, pos) >= 48n)) {
        if (($ailStrAt(value, pos) <= 57n)) {
          if ((dot === 0n)) {
            const $ail_m5: ScalarsResult = std__convert__str_to_dec_from(orig, value, (pos + 1n), ((coeff * 10n) + ($ailStrAt(value, pos) - 48n)), scale, dot, (n - 1n));
            switch ($ail_m5.$ail_kind) {
            case "convert.invalid_decimal": {
              const e = $ail_m5;
              return { $ail_kind: "convert.invalid_decimal", value: e.value };
            ...
            const $ail_m6: ScalarsResult = std__convert__str_to_dec_from(orig, value, (pos + 1n), ((coeff * 10n) + ($ailStrAt(value, pos) - 48n)), (scale + 1n), dot, (n - 1n));
            switch ($ail_m6.$ail_kind) {
            case "convert.invalid_decimal": {
              const e = $ail_m6;
              return { $ail_kind: "convert.invalid_decimal", value: e.value };
...
export function std__convert__str_to_dec(value: string): ScalarsResult {
  if (((BigInt([...value].length)) === 0n)) {
    ...
    if (($ailStrSlice(value, 0n, 1n) === "-")) {
      if (((BigInt([...value].length)) >= 2n)) {
        const $ail_m1: ScalarsResult = std__convert__str_to_dec_from(value, value, 1n, 0n, 0n, 0n, ((BigInt([...value].length)) - 1n));
        switch ($ail_m1.$ail_kind) {
        case "convert.invalid_decimal": {
          const e = $ail_m1;
          return { $ail_kind: "convert.invalid_decimal", value: e.value };
      ...
      const $ail_m2: ScalarsResult = std__convert__str_to_dec_from(value, value, 0n, 0n, 0n, 0n, (BigInt([...value].length)));
      switch ($ail_m2.$ail_kind) {
      case "convert.invalid_decimal": {
        const e = $ail_m2;
        return { $ail_kind: "convert.invalid_decimal", value: e.value };
...
export function std__convert__int_to_dec(value: bigint): ScalarsResult {
  if ((value >= 0n)) {
    const $ail_m1: ScalarsResult = std__convert__int_to_dec_from(value, "0.0", "1.0");
    switch ($ail_m1.$ail_kind) {
    case "ok": {
      const r = $ail_m1;
      return { $ail_kind: "ok", value: r.value };
    ...
    const $ail_m2: ScalarsResult = std__convert__int_to_dec_from((0n - value), "0.0", "-1.0");
    switch ($ail_m2.$ail_kind) {
    case "ok": {
      const r = $ail_m2;
      return { $ail_kind: "ok", value: r.value };
...
export function std__backoff__delay(attempt: bigint, base_ms: bigint, cap_ms: bigint): ScalarsResult {
  ...
  if ($ail_m1 && $ail_m2 && $ail_m3 && $ail_m4) {
    const $ail_m5: ScalarsResult = std__int__pow_from(2n, attempt);
    switch ($ail_m5.$ail_kind) {
    case "ok": {
      const p = $ail_m5;
