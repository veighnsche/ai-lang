...
kept: items 1–6 and 8 shipped with proofs (v06–v09), item 7 closed
...
boundary (exact to 15 digits) is already documented in v04. Small,
...
- The flagship stays the demo vehicle: arithmetic must earn its place
  ...
  Amendment (v11): the "would hang" requirement produced a false
