# v28 — Multi-scrutinee match (proposal)
...
- Precedent docs: `docs/v03-branch-coverage.md` (test-per-arm law),
  `docs/v05-expressiveness.md` (proof-cost sequencing rule).
...
## Native-match refactor (post-v28, same R6)
