# v34 — Boolean names top-up (readonly, required, checked)
...
unchanged from v30. None of these names is advertised as
inert or as appropriate on any element.

## Why now

The v30 review said not to add names merely to appear
...
- The N-1 chain predicted in v30 is now live code: three
