...
> Amendment (v11): the ban is program-wide — see
> `v11-recursion.md`. Same-file cycles stay with this local check;
...
> Amendment (v10): the arithmetic-overflow analogy is retired —
> ints are unbounded and have no overflow mode (`v10-numerics.md`).
