...
Status: shipped. Amendment to v07 (helper termination) and v08
...
The v07 cycle check covered same-file edges only, and foreign calls
...
Separately, v08's theorem relied on negative entry failing loud:
