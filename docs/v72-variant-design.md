...
1. v73 — declaration/registry foundation: parsing,
...
2. v74 — complete value admission: construction,
   ...
   unavailable until v75. Public admission waits
   for the §2.3 identity check while decision 4's
   enforced integrity stands.
3. v75 — complete elimination: case patterns,
   ...
   semantics unchanged).
4. v76 — one pilot consumer: one operation in a
...
- Emit: tag-only nullary member; evaluate-once
  `switch`; strict-tsc green from v74.
