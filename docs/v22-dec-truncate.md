# v22 — Decimal truncation family (truncate, floor, ceil)

Status: shipped. First consumers of the v21 observation primitive:
...
- No compiler changes; no new Go tests (no new Go code path
  exists — the kernel pins from v21 plus the tables plus the
