# v71: explain + machine payloads (v61 item 1, first cut)

Structured diagnostics + `ailc explain`, no language
...
3. Golden: the existing `jsonGolden` AIL3105 line
...
- Probe first (red): `compiler/explain_test.go` —
  ...
  golden mismatch until the AIL3105 line is updated.
