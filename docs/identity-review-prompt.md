...
Paste this into the reviewer with [docs/a67-testing-contracts-design.md](docs/a67-testing-contracts-design.md)
(§2.3 especially), [docs/a72-variant-design.md](docs/a72-variant-design.md)
(decision 4), [docs/a69-contract-grammar.md](docs/a69-contract-grammar.md),
[docs/a73-variant-registry.md](docs/a73-variant-registry.md), and
