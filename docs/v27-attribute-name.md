# v27 — Attribute-name gate (small exact lowercase allowlist)
...
and `attribute__text` composition belong to v28.
...
standing distinction for v28: inexpressible-in-literals is a limit
