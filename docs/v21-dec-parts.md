# v21 — Decimal observation (dec__parts)
...
v16 foresaw exactly this fork: a reserved pure-builtin callee kind
(precedent: `state__get` / `state__put`) or new operator spellings.
v20 chose operators for scalar access — but every v20 operator yields
