# v75 — Variant elimination

Status: shipped. Foundation: [v72 design](v72-variant-design.md)
(decisions 1–8), [v73 registry](v73-variant-registry.md),
[v74 values](v74-variant-values.md). Matching is the last
closed-world proof before the v76 pilot.
...
- `==` over unions stays out (v74): matching is the
  comparison story.

## Out of scope

Same-revision drift (§2.3 identity slice), the v76 pilot,
verifier work.
