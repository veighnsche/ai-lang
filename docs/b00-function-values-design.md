...
adds int/str/bool/dec successes with the same envelope.
[B10](b10-bare-and-extern-returns.md) adds other supported data successes and
bare source Fn factories through ordinary calls. Invocation successes and
extern signatures remain data-only. Other B00 constraints remain;
